<?php
	...
	$LGD_OSTYPE_CHECK           = "P";
	//값 P: XPay 실행(PC 결제 모듈): PC용과 모바일용 모듈은 파라미터 및 프로세스가 다르므로 PC용은 PC 웹브라우저에서 실행 필요. 
...
<script type="text/javascript">
	...
	*/
	function launchCrossPlatform(){
		...
		lgdwin = openXpay(document.getElementById('LGD_PAYINFO'), '<?= $CST_PLATFORM ?>', LGD_window_type, null, width, height);
	}
	/*
	* FORM 명만  수정 가능
	*/
	...
	function payment_return() {
		...
		if (fDoc.document.getElementById('LGD_RESPCODE').value == "0000") {
				...
				document.getElementById("LGD_PAYINFO").action = "/lgxpay/payres";
...
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="/lgxpay/payres">
	<h3 class="text-center">결제 진행 중입니다. XPAY</h3>
