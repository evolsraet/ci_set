<?
    ...
    function lang_profile( $id ) {
        ...
        $lang['bf_profiler_menu_vars']       = '<span>vars</span> &amp; Config';
            ...
            $lang['get_table'] = 'get';
            $lang['post_table'] = 'post';
            $lang['uri_string_table'] = 'uri_string';
            $lang['controller_info_table'] = 'controller_info';
            $lang['headers_table'] = 'headers';
            $lang['config_table'] = 'config';
...
?>
    ...
    <style type="text/css">
        ...
        #ci-profiler-menu a{display:inline-block;font-size:13px;line-height:25px;padding:3px 7px;color:#fff;text-decoration:none;cursor:pointer;}
        ...
        #ci-profiler-menu-constants:hover,#ci-profiler-menu-constants:focus,#ci-profiler-menu-constants.current,#ci-profiler-constants h2{background-color:#b72f09}
        #ci-profiler-menu-constants span{color:#b72f09;}
...
<div id="codeigniter_profiler">
    ...
    // VANILA JS for JQUERY DOCUMENT READY
    ...
    <div id="codeigniter-profiler">
        <div id="ci-profiler-menu">
            ...
            <a href="#ci-profiler-console" id="ci-profiler-menu-console" onclick="ci_profiler_bar.show('ci-profiler-console', 'ci-profiler-menu-console'); return false;">
                <?php echo lang_profile('bf_profiler_menu_console'); ?>
            ...
            <a href="#ci-profiler-memory" id="ci-profiler-menu-memory" onclick="ci_profiler_bar.show('ci-profiler-memory', 'ci-profiler-menu-memory'); return false;">
                <?php echo lang_profile('bf_profiler_menu_memory'); ?>
                <span><?php echo function_exists('memory_get_usage') ? (round(memory_get_usage()/1024/1024, 2) . ' ' . lang_profile('bf_profiler_menu_memory_mb')) : '0'; ?></span>
            </a>
            <?php
                endif;
            ...
            <a href="#ci-profiler-queries" id="ci-profiler-menu-queries" onclick="ci_profiler_bar.show('ci-profiler-queries', 'ci-profiler-menu-queries'); return false;">
                <?php echo lang_profile('bf_profiler_menu_queries_db'); ?>
                <span><?php echo is_array($sections['queries']) ? (count($sections['queries']) - 1) : 0; ?>
                    <?php echo lang_profile('bf_profiler_menu_queries'); ?>
                </span>
            </a>
            <?php
                endif;
            ...
            <a href="#ci-profiler-vars" id="ci-profiler-menu-vars" onclick="ci_profiler_bar.show('ci-profiler-vars', 'ci-profiler-menu-vars'); return false;">
                <?php echo lang_profile('bf_profiler_menu_vars'); ?>
            </a>
            <?php
                endif;
            ...
            <a href="#ci-profiler-files" id="ci-profiler-menu-files" onclick="ci_profiler_bar.show('ci-profiler-files', 'ci-profiler-menu-files'); return false;">
                <?php echo lang_profile('bf_profiler_menu_files'); ?>
            ...
            <!-- 상수 -->
            <a href="#ci-profiler-constants" id="ci-profiler-menu-constants" onclick="ci_profiler_bar.show('ci-profiler-constants', 'ci-profiler-menu-constants'); return false;">
                상수
            </a>
        ...
        <div id="profiler-panel">
            ...
            <p class="ci-profiler-box"><?php echo lang_profile('profiler_no_profiles'); ?></p>
            <?php
            else :
                if (isset($sections['console'])) :
            ?>
            ...
            <div id="ci-profiler-console" class="ci-profiler-box">
                <h2><?php echo lang_profile('bf_profiler_box_console'); ?></h2>
            ...
            <div id="ci-profiler-memory" class="ci-profiler-box">
                <h2><?php echo lang_profile('bf_profiler_box_memory'); ?></h2>
                <?php if (is_array($sections['console'])) : ?>
                <table class="main">
                    <?php
                    foreach ($sections['console']['console'] as $log) :
            ...
            <div id="ci-profiler-benchmarks" class="ci-profiler-box">
                <h2><?php echo lang_profile('bf_profiler_box_benchmarks'); ?></h2>
            ...
            <div id="ci-profiler-queries" class="ci-profiler-box">
                <h2><?php echo lang_profile('bf_profiler_box_queries'); ?></h2>
                ...
                <table class="main">
                    ...
                    <?php
                            ...
                            foreach ((array)$query as $time => $val) :
                    ?>
                    <tr>
            ...
            if (isset($sections['constants'])) :
            ?>
            <!-- 상수들 -->
            <div id="ci-profiler-constants" class="ci-profiler-box">
                <h2>상수</h2>
                <?php if (is_array($sections['constants'])) : ?>
                <table class="main">
                    <?php foreach ((array)$sections['constants'] as $key => $val) : ?>
                    <tr>
            ...
            <div id="ci-profiler-vars" class="ci-profiler-box">
                ...
                <a href="#" onclick="ci_profiler_bar.toggle_data_table('userdata'); return false;">
                    <h2><?php echo lang_profile('bf_profiler_box_session'); ?></h2>
                </a>
            ...
            <div id="ci-profiler-files" class="ci-profiler-box">
                <h2><?php echo lang_profile('bf_profiler_box_files'); ?></h2>
