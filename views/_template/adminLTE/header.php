						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								...
								<p>
									...
									<span>
										lv.<?=$this->logined->mb_level?>
									</span>
									<small><?=$this->logined->mb_created_at?></small>
								</p>
							</li>
							<!-- Menu Body
							<li class="user-body">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="/member/update" class="btn btn-default btn-flat">정보수정</a>
								</div>
			...
			<ul class="sidebar-menu" data-widget="tree">
				...
				<? foreach ( $admin_nav as $nav_key => $nav_row ) : ?>
					<? if ( count($admin_nav_sub[ $nav_key ]) > 1 ) : // 드롭다운 ifelse ?>
						<li class="treeview <?=is_active($menu_depth_1, $nav_key)?>">
							<a href="#">
								<i class="<?=$nav_row['icon']?>"></i>
								<span><?=$nav_row['text']?></span>
							...
							<ul class="treeview-menu">
								<? foreach ( $admin_nav_sub[$nav_key] as $sub_key => $sub_row ) : ?>
									<li class="<?=is_active($menu_depth_2, $sub_key)?>">
					...
					<? else : // 드롭다운 ifelse ?>
						<li class="<?=is_active($menu_depth_1, $nav_key)?>">
