...
class CI_Profiler
{
    ...
    {
        log_message('INFO', 'Profiler 라이브러리 로드');
    ...
    protected function _compile_queries()
    {
        ...
        $highlight = array(
            ...
            'GROUP BY', 'LIMIT', 'INSERT', 'INTO', 'VALUES', 'UPDATE ', 'OR ', 'SET ',
     ...
     * @return  string
     */
    protected function _compile_constants()
    {
        $output = array();
        ...
        // foreach ( (array) $constants as $key => $val) {
        //     $output[$key] = $val;
        // }
    ...
    public function run()
    {
        ...
        if (is_file(VIEWPATH . 'profiler_template.php')) {
            ...
            $this->CI->load->_ci_view_path = VIEWPATH;
