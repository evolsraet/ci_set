<?php
	...
	$this->set_css($this->default_theme_path.'/kmh/css/demo_table_jui.css');
	$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
	$this->set_css($this->default_theme_path.'/kmh/css/datatables.css');
	$this->set_css($this->default_theme_path.'/kmh/css/jquery.dataTables.css');
	$this->set_css($this->default_theme_path.'/kmh/extras/TableTools/media/css/TableTools.css');
	...
	$this->set_js_lib($this->default_theme_path.'/kmh/js/jquery.dataTables.min.js');
	$this->set_js($this->default_theme_path.'/kmh/js/datatables-extras.js');
	$this->set_js($this->default_theme_path.'/kmh/js/datatables.js');
	$this->set_js($this->default_theme_path.'/kmh/extras/TableTools/media/js/ZeroClipboard.js');
	$this->set_js($this->default_theme_path.'/kmh/extras/TableTools/media/js/TableTools.min.js');
...
<?php }
?></div>
<div class="dataTablesContainer form-inline">
	<?php if(!$unset_add){?>
		<div class="datatables-add-button">
		<a class="btn btn-success" href="<?php echo $add_url?>">
			<i class="icon-pencil"></i> <?php echo $this->l('list_add'); ?>
		</a>
		</div>
	<?php }?>
