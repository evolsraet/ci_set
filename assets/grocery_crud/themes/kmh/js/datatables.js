...
$(document).ready(function() {
	...
	$(".groceryCrudTable tfoot input").keyup( function () {
		...
		chosen_table.fnFilter( this.value, chosen_table.find("tfoot input").index(this)+1 );
...
function loadDataTable(this_datatables) {
	return $(this_datatables).dataTable({
	    ...
	    "oTableTools": {
	    	"aButtons": aButtons,
	        "sSwfPath": base_url+"resources/grocery_crud/themes/kmh/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
	    }
	});
}
