                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-success" href="<?php echo $add_url?>"><i class="fa fa-plus"></i> &nbsp;
                                        <?php echo $subject?>
                            ...
                            <div class="floatR">
                                ...
                                <!-- 더미 -->
                                <a class="hidden_search_button hidden" >search</a>
                                ...
                                <tr class="filter-row gc-search-row">
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
                                            <?
                                                $datepicker = '';
                                                if( strpos($column->field_name, '_DATE')!==false )
                                                    $datepicker = 'datepick';
                                            ?>
                                            <input type="text" class="form-control <?=$datepicker?> searchable-input floatL " placeholder="<?php echo $column->display_as; ?> 검색" name="<?php echo $column->field_name; ?>" />
                                        </td>
                                    <?php }?>
                                </tr>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="<?php echo $colspans; ?>">
                                            ...
                                            <div class="floatL t20 l5" style="display: none">
                                            ...
                                            <div old-class="floatR r5" class="text-center">
                                                ...
                                                <ul class="pagination">
                                                    ...
                                                    <li>
                                                        <a href="#" class="page-number-input">1</a>
                                                    </li>
                                                    <!--
                                                    <li>
                                            ...
                                            <div class="floatR r10 t30 hidden">
