<?php
	$this->set_css($this->default_theme_path.'/flexigrid_kmh/css/flexigrid.css');
	...
	$this->set_js($this->default_theme_path.'/flexigrid_kmh/js/cookies.js');
	$this->set_js($this->default_theme_path.'/flexigrid_kmh/js/flexigrid.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/flexigrid_kmh/js/jquery.printElement.min.js');
...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		<?php if(!$unset_add){?>
		<div class="tDiv2">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='btn btn-sm btn-success'>
		...
		<div class="tDiv3">
			<?php if(!$unset_export) { ?>
        	<a class="btn btn-sm btn-default" href="<?php echo $export_url; ?>" download>
	...
	<div class="_sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
            ...
            <input type="button" value="<?php echo $this->l('list_search');?>" class="crud_search  btn btn-sm btn-default" id='crud_search'>
		</div>
        <div class='pull-right _search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear'
        		class="search_clear btn btn-sm btn-default"
        		>
        </div>
	</div>
	<div class="_pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup">
				<div class="pFirst pButton first-button">
					<button class="btn btn-xs btn-default"><i class="fa fa-backward"></i></button>
				</div>
			...
			<div class="pGroup">
				<span class="pcontrol"><?php echo $this->l('list_page'); ?>
					<!-- <span id='crud_page' class="crud_page">1</span> -->
					<input type="text" name='page' value="1" size="4" id='crud_page' class="crud_page">
			...
			<div class="pGroup">
				...
				<div class="pLast pButton last-button">
					<button class="btn btn-xs btn-default"><i class="fa fa-forward"></i></button>
				</div>
			</div>
			<!-- <div class="btnseparator">
			</div> -->
